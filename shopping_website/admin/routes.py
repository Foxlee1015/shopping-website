...
from shopping_website.main.main_fuctions import users_list
...
def admin_page():
    ...
    return render_template('admin.html', m=m, ip_list=ip_list, y=y, p=best_product, l=likes_count_all, product_count=product_count, user_count=user_count)
